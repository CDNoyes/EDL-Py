...
def Draw(figure=None, show=False, label=False, figsize=None, fontsize=16, qlims=[300,800], Mlims=[1.4,2.2]):
...
#     M2 = 2.2
    ...
    plt.plot(Vmax, h/1000, 'r', Vmin, h/1000, 'r', x, y, 'r')
...
#         ax.annotate(r'M > {}'.format(M1), xy=(313, 1.2+h_min/1000), fontsize=fontsize)
        ax.annotate('M < {}'.format(M2), xy=(435, 6 + h_min/1000), fontsize=fontsize)
        ax.annotate('q < {}'.format(q2), xy=(440, 1.5 + h_min/1000), fontsize=fontsize)
        ax.annotate('q > {}'.format(q1), xy=(325, 10.5), fontsize=fontsize)
