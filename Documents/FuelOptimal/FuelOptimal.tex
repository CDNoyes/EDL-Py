...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.9\textwidth]{ignition_dr_cr} 
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.9\textwidth]{ignition_alt_range} 
...
%First steps in defining an entry guidance that seeks an optimal point within a target set. 
%Merit in taking steps to define the target set and define a guidance scheme to seek the best point. Role of entry guidance as a means to deliver to powered descent state. 

%The results may also refute the notion that the solution needs to be coupled...
