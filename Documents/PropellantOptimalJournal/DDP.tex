...
The three phases of the ETPC are prebank, range control, and heading alignment. In the prebank phase, the vehicle manuevers into a prebank attitude intended to begin atmospheric flight near the first expected bank angle command.
